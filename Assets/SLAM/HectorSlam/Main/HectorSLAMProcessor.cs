...
namespace HectorSLAM.Main
{
    ...
    {
        private readonly System.Numerics.Vector3 startPose;
        ...
        /// </summary>
        public System.Numerics.Vector3 LastMapUpdatePose { get; private set; }

        /// <summary>
        /// Last scan match pose
        /// </summary>
        public System.Numerics.Vector3 MatchPose { get; private set; }
        ...
        public HectorSLAMProcessor(float mapResolution, Point mapSize, System.Numerics.Vector3 startPose, int numDepth, int numThreads)
        {
            this.startPose = startPose;

            MapRep = new MapRepMultiMap(mapResolution, mapSize, numDepth, System.Numerics.Vector2.Zero);
            scanMatcher = new ScanMatcher(numThreads);

            // Set initial poses
            MatchPose = startPose;
            LastMapUpdatePose = new System.Numerics.Vector3(float.MinValue, float.MinValue, float.MinValue);
        }
        ...
        public bool Update(ScanCloud scan, System.Numerics.Vector3 poseHintWorld, bool mapWithoutMatching = false)
        {
            ...
            if (System.Numerics.Vector2.DistanceSquared(MatchPose.ToVector2(), LastMapUpdatePose.ToVector2()) > MinDistanceDiffForMapUpdate.Sqr() ||
